...
import com.h.cheng.base.databinding.AcPreviewBinding;
    ...
    protected void initView() {
        ...
        PagerSnapHelper snapHelper = new PagerSnapHelper() {
            ...
            public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX, int velocityY) {
                ...
                binding.tvCount.setText(String.format("%d/%d", currentPosition, imgAdapter.getData().size()));
        ...
        imgAdapter.bindToRecyclerView(binding.rvPreview);
