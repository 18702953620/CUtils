package com.h.cheng.base.widget;
...
public class TitleView extends RelativeLayout {
    ...
    private int DEFAULT_TITLE_SIZE = sp2px(getContext(), 18);
    private int DEFAULT_RIGHT_SIZE = sp2px(getContext(), 14);
    private int DEFAULT_HIGHT = dp2px(getContext(), 44);
    private int DEFAULT_LINE_HIGHT = dp2px(getContext(), 1);
    /**
     * 标题颜色
     */
    ...
    private void init() {
        ...
        layoutRightParams.rightMargin = dp2px(getContext(), 15);
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        needLine = typedArray.getBoolean(R.styleable.TitleView_ps_need_line, true);
